...
#+begin_src elisp
(add-hook 'org-export-before-processing-hook (lambda (arg) (setenv "SOURCE_DATE_EPOCH" (shell-command-to-string "date +%s") )))
(setenv "SOURCE_DATE_EPOCH" (shell-command-to-string "date +%s"))
